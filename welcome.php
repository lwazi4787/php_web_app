...
<header>
<div id = "first_layer">
<div id = "heading_box"><h1 id="heading">Netbase</h1><div id = "form_heading"><?php echo $_SESSION["email"];  ?></div></div></div></header>
<nav id = "id_nav"></nav>
...
<section id = "section_id">
	<h2 id = "form_hading">Welcome <?php require "user_name.php"; ?></h2>
